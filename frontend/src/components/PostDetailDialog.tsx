...
import { usePosts, useRecentPosts, useUpdatePostStatus } from "@/lib/queries";
import { getBrandHue, typeEmoji } from "@/lib/mock-data";
import { StatusBadge } from "./StatusBadge";
import { Calendar, Check, Loader2, MessageSquare, Pencil, Send } from "lucide-react";
...
export function PostDetailDialog({
  ...
  // Cerca il post sia nei post del brand (se disponibili) che nel feed recente
  const post =
